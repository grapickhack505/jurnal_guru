...
<body>
  ...
  <table width="100%" height="100%" style="border: 2px dashed;">
    <tr>
      <td>
        <h2>
          <p align="center">LAPORAN KEGIATAN HARIAN GURU</p>
          <p align="center">TAHUN AJARAN 2022-2023 </p>
        </h2>
        <hr style="border: 2px;">
        <br>

        <p align="center" class="style1"><img src="../images/OZAN_1.png" width="155" height="149" /></p>
        ...
        <p align="center" class="style1">Kp. Pasirjambu Desa Pasirdalem Kec. Kadupandak Kab. Cianjur Jawa Barat</p>
        <p align="center" class="style1"> Email : ozanproject@gmail.com</p>
