...
<body class="bg-dark" style="background-image: url(images/bg-01.jpg);">
    ...
    <div class="container">
      ...
      <div class="login-content" style="background-color:rgba(0,0,0,0.6); border-radius: 20px; ">
        <div class="login-logo">
          <br>
          <center>
            <img src="images/OZAN_1.png" width="130" style="border-radius:100%;">
          </center>
          <h2 style="color: #fff;">Jurnal Harian Pengajar</h2>
          <br> <b style="color: #fff;">Pondok Pesantren El-Bayan</b>
          <p style="color: #fff;">Kelompok 6 Kerja Praktek STMIK Komputama</p>
        </div>
